...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "alexander-k-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/alexander_k"
  #   chef.validation_client_name = "alexander_k-validator"
  #   chef.validation_key_path = ".chef/alexander_k-validator.pem"
  # end
end
